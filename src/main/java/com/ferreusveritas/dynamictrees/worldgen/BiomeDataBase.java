...
//			int biomeId = Biome.getIdForBiome(biome);//This should only return 0 - 255 because of Minecraft limitations
            int biomeId = Registry.BIOME.getId(biome);
...
//		}
    ...
    public static class BiomeEntry {
        ...
        private IChanceSelector chanceSelector = (rnd, spc, rad) -> BiomePropertySelectors.EnumChance.UNHANDLED;
        //		private IDensitySelector densitySelector = (rnd, nd) -> -1;
        private IDensitySelector densitySelector = (rnd, nd) -> 0.4;
