...
//    }
//
//    public static void blendFuncSeparate(SourceFactor p_blendFuncSeparate_0_, DestFactor p_blendFuncSeparate_1_, SourceFactor p_blendFuncSeparate_2_, DestFactor p_blendFuncSeparate_3_) {
//        assertThread(RenderSystem::isOnGameThread);
...
//    }
//
//    public static void fogMode(FogMode p_fogMode_0_) {
//        assertThread(RenderSystem::isOnGameThread);
...
//    }
//
//    public static void logicOp(LogicOp p_logicOp_0_) {
//        assertThread(RenderSystem::isOnGameThread);
...
//            int lvt_0_1_ = GlStateManager.getInteger(3379);
//
//            for(int lvt_1_1_ = Math.max(32768, lvt_0_1_); lvt_1_1_ >= 1024; lvt_1_1_ >>= 1) {
//                GlStateManager.texImage2D(32868, 0, 6408, lvt_1_1_, lvt_1_1_, 0, 6408, 5121, (IntBuffer)null);
//                int lvt_2_1_ = GlStateManager.getTexLevelParameter(32868, 0, 4096);
//                if (lvt_2_1_ != 0) {
...
//        GlStateManager.bindBuffer(p_glBindBuffer_0_, (Integer)p_glBindBuffer_1_.get());
//    }
//
