...
public class MeristemFactory {
    ...
    public Meristem createAxillaryMeristem(int age, BlockPos pos, GrowthVec dir) {
        ...
        meristem.init(age, pos, dir, this, grower, terminator);
        return meristem;
    }
    ...
    public static class Builder {
        ...
        public MeristemFactory build(Species species) {
            return new MeristemFactory(species).init(maxHeight, minimumBranchAge, meristemsPerNode, meristemsPerNodeVariance, meristemsPerAxillaryNode, meristemsPerAxillaryNodeVariance, angleOffsetPerNode, angleOffsetVariance, axillaryAgeOffset, axillaryAgeOffsetVariance, terminalRegenRate);
        }
    }
