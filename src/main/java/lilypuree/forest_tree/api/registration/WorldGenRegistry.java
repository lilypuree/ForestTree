...
public class WorldGenRegistry {
    ...
    private static final String CONFIGPATH = "/" + ForestTree.MODID;
...
//        return ModConfigs.worldGen;
    ...
    private static IBiomeDataBasePopulator collectDataBasePopulators() {
        ...
        event.register(new BiomeDataBasePopulatorJson(new ResourceLocation(ForestTree.MODID, RESOURCEPATH)));
...
//        }
    ...
    public static void populateDataBase() {
        if (WorldGenRegistry.isWorldGenEnabled()) {
            ...
            WorldTreeGenerator.getWorldTreeGenerator().clearAllBiomeDataBases();
            BiomeDataBase database = WorldTreeGenerator.getWorldTreeGenerator().getDefaultBiomeDataBase();
...
//            ModConfigs.dimensionBlacklist.forEach(d -> TreeGenerator.getTreeGenerator().BlackListDimension(d));
    ...
    public static boolean validateBiomeDataBases() {
        if (WorldGenRegistry.isWorldGenEnabled()) {
            return WorldTreeGenerator.getWorldTreeGenerator().validateBiomeDataBases();
        }
        return true;
    }
