...
public class Parameter {
    ...
    public static final Parameter[][] parameters = new Parameter[][]{
            {p("maxHeight", 0), p("minimumBranchAge", 0), p("maximumBranchOrder", 0), pf("meristemsPerNode"), pf("meristemsPerNodeVariance"), pf("meristemsPerAxillaryNode"), pf("meristemsPerAxillaryNodeVariance"), pf("angleOffsetPerNode"), pf("angleOffsetVariance"), pf("axillaryAgeOffset"), pf("axillaryAgeOffsetVariance"), pf("terminalRegenRate")},
