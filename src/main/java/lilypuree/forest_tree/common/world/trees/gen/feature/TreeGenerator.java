...
import lilypuree.forest_tree.common.world.trees.gen.feature.parametric.Meristem;
import lilypuree.forest_tree.common.world.trees.gen.feature.parametric.MeristemFactory;
...
//TODO
    ...
    private void makeBranch(Meristem meristem) {
        Block branch = TreeBlockRegistry.getBranchBlock(meristem.getSourceDirection(), factory.getSpecies().getWood());
        placer.addBranch(meristem.getPos(), branch.getDefaultState().with(ModBlockProperties.THICKNESS, meristem.getAge()));
    }
