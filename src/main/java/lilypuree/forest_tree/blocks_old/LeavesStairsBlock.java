...
//
//public class LeavesStairsBlock extends LeavesBlock implements IShearable, ILeafBlock{
//    public static final DirectionProperty FACING = HorizontalBlock.HORIZONTAL_FACING;
//    public static final EnumProperty<Half> HALF = BlockStateProperties.HALF;
//    public static final EnumProperty<StairsShape> SHAPE = BlockStateProperties.STAIRS_SHAPE;
//    public static final BooleanProperty WATERLOGGED = BlockStateProperties.WATERLOGGED;
//    protected static final VoxelShape AABB_SLAB_TOP = LeavesSlabBlock.TOP_SHAPE;
//    protected static final VoxelShape AABB_SLAB_BOTTOM = LeavesSlabBlock.BOTTOM_SHAPE;
...
//
//    public LeavesStairsBlock(Supplier<BlockState> state, Block.Properties properties){
//        super(properties);
...
//        BlockState blockstate = super.getDefaultState().with(FACING, context.getPlacementHorizontalFacing()).with(HALF, direction != Direction.DOWN && (direction == Direction.UP || !(context.getHitVec().y - (double)blockpos.getY() > 0.5D)) ? Half.BOTTOM : Half.TOP).with(WATERLOGGED, Boolean.valueOf(ifluidstate.getFluid() == Fluids.WATER));
...
//        return state.getBlock() instanceof LeavesStairsBlock || state.getBlock() instanceof StairsBlock;
//    }
//
//
