...
//        if(facingState.getBlock() instanceof TreeTrunk) {
//
//        }
//
...
//    }
//
//    private boolean canConnectUpwards(Direction facing, BlockState state){
//        return state.get(ForestTreeProperties.getConnectionBasedOnDirection(facing)) == BranchType.UP;
//    }
//
//    @Override
...
//            Direction blockFacing = block.get(FACING);
//            if (block.get(ForestTreeProperties.MAIN_BRANCH)) {
//                if (!worldIn.isRemote()) {
//                    if (facing == Direction.DOWN || facing == blockFacing) {
...
//                    } else if (facing == blockFacing.rotateY()) {
//                        worldIn.setBlockState(pos, block.cycle(RIGHT_BRANCH));
//                    } else if (facing == blockFacing.rotateYCCW()) {
...
//                case NORTH:
//                    worldIn.setBlockState(facingPos, facingState.with(ForestTreeProperties.NORTH_CONNECTION, BranchType.SIDE), 3);
//                    break;
//                case SOUTH:
//                    worldIn.setBlockState(facingPos, facingState.with(ForestTreeProperties.SOUTH_CONNECTION, BranchType.SIDE), 3);
//                    break;
//                case EAST:
//                    worldIn.setBlockState(facingPos, facingState.with(ForestTreeProperties.EAST_CONNECTION, BranchType.SIDE), 3);
//                    break;
//                case WEST:
//                    worldIn.setBlockState(facingPos, facingState.with(ForestTreeProperties.WEST_CONNECTION, BranchType.SIDE), 3);
//                    break;
//            }
//        }
//
