...
public enum WoodTypes {
    ...
    public Block getWood(){
        switch (this){
            case OAK: return Blocks.OAK_WOOD;
            case SPRUCE: return Blocks.SPRUCE_WOOD;
            case BIRCH: return Blocks.BIRCH_WOOD;
            case JUNGLE: return Blocks.JUNGLE_WOOD;
            case DARK_OAK: return Blocks.DARK_OAK_WOOD;
            case ACACIA: return Blocks.ACACIA_WOOD;
        }
    ...
    public Block getLeaves(){
        switch (this){
            ...
            case DARK_OAK: return Blocks.DARK_OAK_LEAVES;
    ...
    public Item getSapling(){
        switch (this){
            case OAK: return Items.OAK_SAPLING;
            case BIRCH: return Items.BIRCH_SAPLING;
            case SPRUCE: return Items.SPRUCE_SAPLING;
            case JUNGLE: return Items.JUNGLE_SAPLING;
            case DARK_OAK: return Items.DARK_OAK_SAPLING;
            case ACACIA: return Items.ACACIA_SAPLING;
