...
import lilypuree.forest_tree.world.feature.features.DenseFlowerPatchFeature;
import lilypuree.forest_tree.world.trees.gen.feature.AdvancedTreeFeature;
import lilypuree.forest_tree.world.trees.gen.feature.TreeConfig;
...
//    public static final Feature<AdvancedTreeFeatureConfig> PINE = new CedarTreeFeature((ops)-> ForestTreeFeatureConfigs.PINE_CONFIG);
    ...
    public static final WorldTreeFeature<NoFeatureConfig> TREE = new WorldTreeFeature<>(NoFeatureConfig::deserialize);
